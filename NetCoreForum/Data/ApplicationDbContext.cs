...
namespace NetCoreForum.Data
{
    public class ApplicationDbContext : IdentityDbContext<AppUser, AppRole, string>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            if (!modelBuilder.Model.GetEntityTypes().Any(t => t.ClrType == typeof(EmailTemplate)))
            {
            ...
            // SiteSettings verisini ekleme
            if (!modelBuilder.Model.GetEntityTypes().Any(t => t.ClrType == typeof(SiteSettings)))
            {
            ...
            // EmailConfiguration verisini ekleme
            if (!modelBuilder.Model.GetEntityTypes().Any(t => t.ClrType == typeof(EmailConfiguration)))
            {
            ...
            if (!modelBuilder.Model.GetEntityTypes().Any(t => t.ClrType == typeof(ErrorMessage)))
            {
