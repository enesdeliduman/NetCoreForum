...
namespace NetCoreForum.Migrations
{
    ...
    [Migration("20241012214956_InitialCreate")]
            ...
            modelBuilder.Entity("NetCoreForum.Entities.EmailTemplate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 10, 12, 21, 49, 55, 405, DateTimeKind.Utc).AddTicks(6606),
                            Subject = "Şifre Sıfırlama Talebi",
                            TemplateName = "Şifremi Unuttum",
                            UpdatedAt = new DateTime(2024, 10, 12, 21, 49, 55, 405, DateTimeKind.Utc).AddTicks(6606)
                        },
                        new
                        {
                            EmailTemplateID = 2,
                            Body = "Kayıt olduğunuz için teşekkürler! Hesabınıza hoş geldiniz.",
                            CreatedAt = new DateTime(2024, 10, 12, 21, 49, 55, 405, DateTimeKind.Utc).AddTicks(6609),
                            Subject = "Hoş geldiniz!",
                            TemplateName = "Hoş Geldiniz",
                            UpdatedAt = new DateTime(2024, 10, 12, 21, 49, 55, 405, DateTimeKind.Utc).AddTicks(6610)
                        },
                        new
                        {
                            EmailTemplateID = 3,
                            Body = "Şifreniz başarıyla değiştirildi. Herhangi bir sorunla karşılaşırsanız, lütfen bizimle iletişime geçin.",
                            CreatedAt = new DateTime(2024, 10, 12, 21, 49, 55, 405, DateTimeKind.Utc).AddTicks(6612),
                            Subject = "Şifre Değişikliğiniz Başarılı",
                            TemplateName = "Şifre Değişikliği",
                            UpdatedAt = new DateTime(2024, 10, 12, 21, 49, 55, 405, DateTimeKind.Utc).AddTicks(6613)
                        },
                        new
                        {
                            EmailTemplateID = 4,
                            Body = "Hesabınız başarıyla onaylandı. Artık sitemizi kullanabilirsiniz.",
                            CreatedAt = new DateTime(2024, 10, 12, 21, 49, 55, 405, DateTimeKind.Utc).AddTicks(6615),
                            Subject = "Hesabınız Onaylandı",
                            TemplateName = "Hesap Onayı",
                            UpdatedAt = new DateTime(2024, 10, 12, 21, 49, 55, 405, DateTimeKind.Utc).AddTicks(6615)
                        });
                });
